...
(function (window, document, Math) {
  ...
  function IScroll(el, options) {
    ...
    this.minScrollX = this.options.minScrollX; // Normalize options
  ...
  IScroll.prototype = {
    ...
    resetPosition: function resetPosition(time) {
      ...
      if ((!this.hasVerticalScroll || this.y >= this.minScrollY) && this.isTouching) {
        y = this.minScrollY;
      }
    ...
    _execEvent: function _execEvent(type) {
      ...
      for (; i < l; i++) {
        var event = this._events[type][i];
        event && event.apply(this, [].slice.call(arguments, 1));
      }
    },
    ...
    _initIndicators: function _initIndicators() {
      ...
      function _indicatorsMap(fn) {
        if (that.indicators) {
          for (var _i = that.indicators.length; _i--;) {
            fn.call(that.indicators[_i]);
          }
        }
      }
  ...
  IScroll.utils = utils;
  gIScroll = IScroll; // module.exports = IScroll;
...
(function () {
  ...
  reactHotLoader.register(gIScroll, "gIScroll", "/Users/sujialong/Documents/myPlugins_NPM/react-s-listview/lib/ListView/libs/iscroll-probe.js");
})();
